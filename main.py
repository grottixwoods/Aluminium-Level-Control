...
if __name__ == '__main__':
    ...
    # TODO:
    # 1) логика заполнения линии снизу в вверх, иначе вывод warning
    # 2) сглаживание выбросов путем замены выброса на среднюю по всему региону
    #    оставляем флаг о том что выброс есть
